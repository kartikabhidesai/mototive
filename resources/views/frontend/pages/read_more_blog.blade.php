        ...
        <div class="row">
            <div class="col-lg-9">
                    ...
                    <div class="blog_content bg-white">
                        <div class="blog_text">
                            ...
                            <ul class="list_none blog_meta">
                                ...
                                <li><a href="#"><i class="ion-chatboxes"></i> {{ isset($blog_cmt) ? (count($blog_cmt)) : '' }}&nbsp;Comment</a></li>
                            </ul>
                            <p>{{ $result->content }}</p>
                ...
                <div class="comment-area border-top">
                    @if(count($blog_cmt) != 0)
                    <div class="comment-title mb-2 mb-sm-4">
                        <h5>{{ isset($blog_cmt) ? '('.(count($blog_cmt)).')' : '' }}&nbsp;Comment</h5>
                    </div>
                    @else
                    <div class="comment-title mb-2 mb-sm-4">
                        <h5>feel so honored to be the first comment</h5>
                    </div>
                    @endif
                    <ul class="list_none comment_list">
                        @foreach($blog_cmt as $comment)
                        <li class="comment_info">
                            <div class="d-flex">
                                <!--                                <div class="user_img">
                                                                    <img src="assets/images/user2.jpg" alt="user2">
                                                                </div>-->
                                <div class="comment_content col-lg-9">
                                    <div class="d-flex align-items-md-center">
                                        <div class="meta_data">
                                            <h6><a href="#">{{ $comment->blg_cmt_name }}</a></h6>
                                            <p>{{ $comment->blg_cmt }}</p>
                                        </div>
                                ...
                                <div class="ml-auto">
                                    ...
                                    <div class="comment-time"><i class="ion-calendar"></i>&nbsp;{{ strftime( '%Y-%m-%d', strtotime($comment->created_at)) }}&nbsp;{{substr($comment->created_at, strpos($comment->created_at, " ") + 1) }}</div>
                                </div>
                            </div>
                        </li>
                        @endforeach
                    ...
                    <form method="post" id="blogcommentform">{{ csrf_field() }}
                        <div class="row">
                            <div class="form-group col-md-6">
                                <input name="blg_cmt_name" class="form-control" id="blg_cmt_name" placeholder="Your Name"  type="text">
                            </div>
                            <div class="form-group col-md-6">
                                <input name="blg_cmt_email" class="form-control" id="blg_cmt_email" placeholder="Your Email"  type="email">
                            </div>
                            <div class="form-group col-md-12">
                                <textarea rows="3" name="blg_cmt" class="form-control" id="blg_cmt" placeholder="Your Comment" ></textarea>
                            </div>
                            <div class="form-group col-md-12">
                                <button value="Submit" name="submit" id="submit" class="btn btn-default" title="Submit Your Comment!" type="submit">Submit</button>
                            </div>
                        </div>
                        <input name="blogid" id="blogid"  type="hidden" value="{{ isset($blog) ? $blog[0]->id : '' }}">
                    </form>
                </div>
            </div>
