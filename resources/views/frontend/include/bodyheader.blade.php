    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg"> 
            <a class="navbar-brand" href="index-2.html">
                <img class="logo_light" src="{{ url('frontend/assets/images/logo_white.png') }}" alt="logo" />
                <img class="logo_dark" src="{{ url('frontend/assets/images/logo_dark.png') }}" alt="logo" />
                <img class="logo_default" src="{{ url('frontend/assets/images/logo_dark.png') }}" alt="logo" />
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        ...
                        <div class="dropdown-menu">
                          <ul class="mega-menu d-lg-flex">
                              <li class="mega-menu-col col-lg-3">
                                    <ul> 
                                        <li>
                                            <a class="dropdown-item menu-link dropdown-toggler active" href="index-2.html">Home - Creative</a>
                                            <div class="dropdown-menu">
                                                <ul> 
                                                    <li><a class="dropdown-item nav-link nav_item active" href="index-2.html">Creative Layout 1</a></li> 
                                                    <li><a class="dropdown-item nav-link nav_item" href="index-3.html">Creative Layout 2</a></li>
                                                    <li><a class="dropdown-item nav-link nav_item" href="index-4.html">Creative Layout 3</a></li>
                                                </ul>
                                            </div>
                                        </li>
                                        <li>
                                            <a class="dropdown-item menu-link dropdown-toggler" href="index-2.html">Home - Landing page</a>
                                            <div class="dropdown-menu">
                                                <ul> 
                                        ...
                                        <li>
                                            <a class="dropdown-item nav-link nav_item" href="index-5.html">Home - Business</a>
                                       </li>
                                       <li>
                                            <a class="dropdown-item nav-link nav_item" href="index-6.html">Home - One Page</a>
                                       </li>
                                       <li>
                                            <a class="dropdown-item nav-link nav_item" href="index-7.html">Home - Portfolio</a>
                                       </li>
                                   </ul>
                               <li class="mega-menu-col col-lg-3">
                                   <ul>
                                       <li>
                                            <a class="dropdown-item nav-link nav_item" href="index-8.html">Home - Restaurant</a>
                                       </li>
                                       <li>
                                            <a class="dropdown-item nav-link nav_item" href="index-9.html">Home - Construction</a>
                                       </li>
                                       <li>
                                            <a class="dropdown-item nav-link nav_item" href="index-10.html">Home - Medical</a>
                                       </li>
                                       <li>
                                            <a class="dropdown-item nav-link nav_item" href="index-11.html">Home - Gym</a>
                                       </li>
                                       <li>
                                            <a class="dropdown-item nav-link nav_item" href="index-12.html">Home - Consultancy</a>
                                       </li>
                                   </ul>
                               </li>
                                <li class="mega-menu-col col-lg-3">
                                   <ul>
                                       <li>
                                            <a class="dropdown-item nav-link nav_item" href="index-13.html">Home - Shop</a>
                                       </li>
                                       <li>
                                            <a class="dropdown-item nav-link nav_item" href="index-16.html">Home - Digital Agency</a>
                                       </li>
                                       <li>
                                            <a class="dropdown-item nav-link nav_item" href="index-17.html">Home - SEO Marketing</a>
                                       </li>
                                       <li>
                                            <a class="dropdown-item nav-link nav_item" href="index-18.html">Home - Web Agency</a>
                                       </li>
                                       <li>
                                            <a class="dropdown-item nav-link nav_item" href="index-19.html">Home - Agriculture</a>
                                       </li>
                                   </ul>
                               </li>
                                <li class="mega-menu-col col-lg-3">
                                   <ul>
                                       <li>
                                            <a class="dropdown-item nav-link nav_item" href="index-20.html">Home - Blog</a>
                                       </li>
                                       <li>
                                            <a class="dropdown-item nav-link nav_item" href="index-21.html">Home - Wedding</a>
                                       </li>
                                       <li>
                                            <a class="dropdown-item nav-link nav_item" href="index-22.html">Home - Travel</a>
                                       </li>
                                   </ul>
                               </li>
                            </ul>
                                ...
                                <li>
                                    ...
                                    <div class="dropdown-menu">
                                        <ul> 
                                            ...
                                            <li><a class="dropdown-item nav-link nav_item" href="footer-style4.html">Footer Style 4 </a></li>
                                            <li><a class="dropdown-item nav-link nav_item" href="footer-style5.html">Footer Style 5 </a></li>
                                            <li><a class="dropdown-item nav-link nav_item" href="footer-style6.html">Footer Style 6 </a></li>
                                            <li><a class="dropdown-item nav-link nav_item" href="footer-style7.html">Footer Style 7 </a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="dropdown-menu">
                                        <ul> 
                                            ...
                                            <li><a class="dropdown-item nav-link nav_item" href="menu-style4.html">Menu Styles 4</a></li>
                                            <li><a class="dropdown-item nav-link nav_item" href="menu-style5.html">Menu Styles 5</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="dropdown-menu">
                                        <ul> 
                                            ...
                                            <li><a class="dropdown-item nav-link nav_item" href="page-title-dark.html">Dark Style</a></li>
                                            <li><a class="dropdown-item nav-link nav_item" href="page-title-pattern.html">Pattern Background</a></li>
                                            <li><a class="dropdown-item nav-link nav_item" href="page-title-video.html">HTML5 Video</a></li>
                                            <li><a class="dropdown-item nav-link nav_item" href="page-title-backgroung.html">Custome Background</a></li>
                                            <li><a class="dropdown-item nav-link nav_item" href="page-title-mini-version.html">Mini Version</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li>
                ...
                <li class="dropdown dropdown-mega-menu">
                    <a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown">Portfolio</a>
                        <div class="dropdown-menu">
                            <ul class="mega-menu d-lg-flex">
                            	<li class="mega-menu-col col-lg-3">
                                    <ul> 
                                ...
                                <li class="mega-menu-col col-lg-3">
                                    <ul> 
                                        ...
                                        <li><a class="dropdown-item nav-link nav_item" href="portfolio-carousel.html">Portfolio Carousel</a></li>
                                        <li><a class="dropdown-item nav-link nav_item" href="portfolio-carousel-wide.html">Portfolio Carousel Wide</a></li>
                                        <li><a class="dropdown-item nav-link nav_item" href="portfolio-nomargin.html">Portfolio No-Margin</a></li>
                                        <li><a class="dropdown-item nav-link nav_item" href="portfolio-nomargin-wide.html">Portfolio No-Margin Wide</a></li>
                                        <li><a class="dropdown-item nav-link nav_item" href="portfolio-load-more.html">Load More</a></li>
                                        <li><a class="dropdown-item nav-link nav_item" href="portfolio-selectbox.html">Portfolio Select Box</a></li>
                                    </ul>
                                </li>
                                <li class="mega-menu-col col-lg-3">
                                    <ul> 
                            ...
                            <ul class="mega-menu d-lg-flex">
                                ...
                                <li class="mega-menu-col col-lg-3">
                                    <ul> 
                                        ...
                                        <li><a class="dropdown-item nav-link nav_item" href="blog-list-nosidebar.html">No sidebar</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
            ...
            <ul class="navbar-nav attr-nav align-items-center">
                    ...
                    <li class="dropdown"><a class=" nav-link" href="#" data-toggle="dropdown"><i class="ion-android-cart"></i><span class="cart_count">2</span></a>
                        <div class="cart_box dropdown-menu dropdown-menu-right">
                            <ul class="cart_list">
                                <li>
                                    <a href="#" class="item_remove"><i class="ion-close"></i></a>
                                    <a href="#"><img src="{{ url('frontend/assets/images/cart_thamb1.png') }}" alt="cart_thumb1"/>Variable product 001</a>
                                    <span class="cart_quantity"> 1 x <span class="cart_amount"> <span class="price_symbole">$</span></span>78.00</span></span>
                                </li>
                                <li>
                                    <a href="#" class="item_remove"><i class="ion-close"></i></a>
                                    <a href="#"><img src="{{ url('frontend/assets/images/cart_thamb2.png') }}" alt="cart_thumb2"/>Ornare sed consequat</a>
                                    <span class="cart_quantity"> 1 x <span class="cart_amount"> <span class="price_symbole">$</span></span>81.00</span></span>
                                </li>
                            </ul>
                            <div class="cart_footer">
                                <p class="cart_total"><strong>Subtotal:</strong> <span class="cart_amount"> <span class="price_symbole">$</span></span>159.00</span></p>
                                <p class="cart_buttons"><a href="#" class="btn view-cart">View Cart</a><a href="#" class="btn checkout">Checkout</a></p>
                            </div>
                        </div>
                    </li>
                </ul>
