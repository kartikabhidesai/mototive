                ...
                <div class="card">
                    <div class="card-header text-right">
                        <div class="row p-b-20 pull-right">
                            <div class="btn-group">
                                <button class="btn  btn-sm btn-info has-ripple" data-toggle="modal" data-target="#addmodal"><i class="feather icon-plus"></i> Add Client</button>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table id="clientdatatable" class="table mb-0">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editclientform" name="editclientform" method="post" action="{{ route('editclient') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class=" editdiv">
...
<div id="addmodal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="addproductmodel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="addclient" name="addclient" method="post"  enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <div><br>
                                    <input type="text" class="form-control" name="name" placeholder="Enter Client Name"><br>
                                    <input type="text" class="form-control" name="phone" placeholder="Enter Phone Number"><br>
                                    <textarea class="form-control" name="email" placeholder="Enter Email here"></textarea><br>
                                    <textarea class="form-control" name="address" placeholder="Enter Address here"></textarea><br>
                                </div>
                            </div>
                        </div>
                    </div>
